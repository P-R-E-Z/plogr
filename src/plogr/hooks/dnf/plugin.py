...
from plogr.config import Config
from plogr.logger import PackageLogger
...
class PkgLogger(dnf.Plugin if dnf else object):  # type: ignore[misc]
    """DNF plugin for logging package transactions to plogr"""
    ...
    def transaction(self) -> None:
        """Log package transactions to plogr"""
        self.logger.info("plogr plugin transaction method called")
